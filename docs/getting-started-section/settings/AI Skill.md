...
Your AI assistant is great at writing code — but it doesn't know Voiden's `.void` format out of the box. AI Skill fixes that. Enable it once, and your assistant gains everything it needs to write, edit, and generate valid `.void` files right alongside you.
