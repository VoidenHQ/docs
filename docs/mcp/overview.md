...
Start with **Initialize MCP** — it's the fastest way to let an agent work in your project, and most people never need more than that. Reach for `/mcp` to test someone else's server, or `/tool` + `@voiden/mcp` when you're ready to publish your own.
