...
description: "Import Insomnia v4 collection exports (.json) into Voiden — preserves folder structure, headers, query params, request bodies, and authentication."
custom_edit_url: "https://github.com/phurpa-tsering/insomnia-importer"
---

:::info Plugin Info
**Author:** Phurpa Tsering &nbsp;|&nbsp; **Version:** 1.0.0 &nbsp;|&nbsp; **Repository:** [phurpa-tsering/insomnia-importer](https://github.com/phurpa-tsering/insomnia-importer)
:::
